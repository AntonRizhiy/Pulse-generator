...
#define UART_BUFFER_EQUALS_IDX (2) // EQUALS - Symbol "="
#define UART_BUFFER_CHANNEL_IDX (3)
#define UART_BUFFER_PLUS_IDX (4) // PLUS - Symbol "+"
#define UART_BUFFER_D_VALUE_IDX (5)
#define UART_BUFFER_H_VALUE_IDX (6)
#define UART_BUFFER_L_VALUE_IDX (7)
...
void UartBufferParser(void)
{
 ...
 if ('+' != UartBuffer[UART_BUFFER_PLUS_IDX])
    {
        Error_Return();
        return;
    }
